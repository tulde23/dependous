...
namespace Dependous.Test45
{
    ...
    public class ScanTest
    {
        ...
        public void test_custom_assembly_locator_and_type_service()
        {
            ...
            Assert.IsTrue(results.Metadata.Any());
        }
        ...
        public void TestScanProducesSomeResults()
        {
            ...
            var scanResult = instance.Scan((f) => f.StartsWith("Dependous.Test.Common"), c => c.AddProbingPaths(pb => pb.AddProbingPath("../../../../tests/Dependous.Probing/bin/Debug/net45")));

            Assert.IsTrue(scanResult.Metadata.Any());
        }
